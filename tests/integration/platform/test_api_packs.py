...
class TestListPacks:
    ...
    def test_pack_summary_fields(self, client: TestClient) -> None:
        ...
        assert labos["tool_count"] == 19  # 4 domain + 15 platform tools
...
class TestGetPack:
    def test_labos_details(self, client: TestClient) -> None:
        ...
        assert len(data["tools"]) == 19  # 4 domain + 15 platform tools
    ...
    def test_codeos_details(self, client: TestClient) -> None:
        ...
        assert len(data["tools"]) == 22  # 7 domain + 15 platform tools
